...
for i = 1: length(A.FileName)
    ...
    stm.Vis.SesDurTotal = S.SesDurTotal;
    if stm.Vis.SesDurTotal == S.SesDurTotal
        ...
        S.TrlIndexSoundNum=	1; %stm.Vis.TrlIndexSoundNum;
        S.TrlIndexAddAttNum=0; %stm.Vis.TrlIndexAddAttNum;
        S.SesCycleDurTotal=	stm.Vis.SesCycleDurTotal;
        S.SesCycleNumTotal=	stm.Vis.SesCycleNumTotal;
        S.SesDurTotal =     stm.Vis.SesDurTotal;        
        S.SesSoundDurTotal= stm.Vis.SesCycleDurTotal; %SesSoundDurTotal;
        S.AddAtts =         0; %stm.Vis.AddAtts;
        S.AddAttNumTotal =  stm.Vis.SesCycleNumTotal; %AddAttNumTotal;
        S.SesTrlOrder =     stm.Vis.SesTrlOrder;
        S.SesTrlOrderMat =  stm.Vis.SesTrlOrderMat;
        S.SesTrlOrderVec =  stm.Vis.SesTrlOrderVec;
        S.SesTrlOrderSoundVec = ones(length(stm.Vis.SesTrlOrderVec), 1); %stm.Vis.SesTrlOrderSoundVec;
    else
